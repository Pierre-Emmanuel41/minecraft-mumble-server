...
public enum EMumbleMessageCode implements IMinecraftMessageCode {
	...
	// Code for command deafen
	DEAFEN__EXPLANATION, DEAFEN__ALL_PLAYERS_DEAFEN, DEAFEN__PLAYER_NOT_REGISTERED_IN_A_CHANNEL, DEAFEN__NO_PLAYER_DEAFEN, DEAFEN__ONE_PLAYER_DEAFEN,
	DEAFEN__SEVERAL_PLAYERS_DEAFEN,

	// Code for command kick
	KICK__EXPLANATION, KICK__ALL_PLAYERS_KICKED, KICK__PLAYER_NOT_REGISTERED_IN_CHANNEL, KICK__NO_PLAYER_KICKED, KICK__ONE_PLAYER_KICKED, KICK__SEVERAL_PLAYERS_KICKED,
